...
API_TOKEN = '7833773242:AAFNzSCqy7uA724WJhaVy4GQ0GnSQKyMKG8'
ADMIN_ID = 549809057
CHANNEL_USERNAME = '@GGpoker_ua_official'
YOUTUBE_LINK = 'https://www.youtube.com/@GGPokerUA'
TWITCH_LINK = 'https://twitch.tv/your_channel_here'
SUPPORT_USERNAME = '@GGPokerSupport'
        ...
        if state == 'awaiting_nickname':
            ...
            if save_participant(message.from_user, nickname, email):
                ...
                await message.reply(
                    ...
                    "ℹ️ Але ви все одно можете користуватись ботом — дізнавайтесь новини, переглядайте умови, пишіть у підтримку!"
                )
            return
...
async def main():
    pool = await asyncpg.create_pool(
        user='postgres',
        password='Erika3726130',
        database='ggpoker_bot',
        host='localhost',
        port=5432
    )
    dp['db'] = pool
